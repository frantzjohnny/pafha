...
const JoinView = ({ onBack }) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    setIsSubmitted(true);
    // Integrate API or Firebase call here in a real app
    setTimeout(() => {
      onBack();
    }, 4000);
  };
                  ...
                  <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="space-y-6">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        ...
                        <input required className="w-full bg-surface-2 p-4 rounded-xl outline-none focus:ring-2 ring-accent transition-all text-sm" placeholder="Ex: Agence pour le Développement..." />
                      </div>
                      <div className="space-y-2">
                        <label className="text-[10px] font-bold uppercase tracking-widest text-text-light ml-2">Sigle / Acronyme</label>
                        <input className="w-full bg-surface-2 p-4 rounded-xl outline-none focus:ring-2 ring-accent transition-all text-sm" placeholder="Ex: AHDEL" />
                      </div>
                    </div>
                    <div className="space-y-2">
                      <label className="text-[10px] font-bold uppercase tracking-widest text-text-light ml-2">Année de création</label>
                      <input type="number" className="w-full bg-surface-2 p-4 rounded-xl outline-none focus:ring-2 ring-accent transition-all text-sm" placeholder="2024" />
                    </div>
                    <div className="flex justify-end pt-4">
                      <button type="button" onClick={() => setStep(2)} className="btn-primary">Continuer <ArrowRight size={18} /></button>
                    </div>
                  </motion.div>
                )}
                  ...
                  <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="space-y-6">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        ...
                        <input required type="email" className="w-full bg-surface-2 p-4 rounded-xl outline-none focus:ring-2 ring-accent transition-all text-sm" placeholder="contact@association.org" />
                      </div>
                      <div className="space-y-2">
                        <label className="text-[10px] font-bold uppercase tracking-widest text-text-light ml-2">Téléphone</label>
                        <input className="w-full bg-surface-2 p-4 rounded-xl outline-none focus:ring-2 ring-accent transition-all text-sm" placeholder="01 23 45 67 89" />
                      </div>
                    </div>
                    <div className="space-y-2">
                      ...
                      <input className="w-full bg-surface-2 p-4 rounded-xl outline-none focus:ring-2 ring-accent transition-all text-sm" placeholder="Jean Dupont" />
                    </div>
                    <div className="flex justify-between pt-4">
                      ...
                      <button type="button" onClick={() => setStep(3)} className="btn-primary">Continuer <ArrowRight size={18} /></button>
                    </div>
                  </motion.div>
                )}
                ...
                {step === 3 && (
                  <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex flex-wrap gap-3">
                        {['Agriculture', 'Éducation', 'Santé', 'Économie', 'Culture', 'Numérique'].map(tag => (
                          <label key={tag} className="flex items-center gap-2 px-4 py-2 bg-surface-2 rounded-full cursor-pointer hover:bg-accent/10 transition-all border border-transparent has-[:checked]:border-secondary has-[:checked]:bg-secondary/5">
                    ...
                    <div className="space-y-2">
                      ...
                      <textarea rows={4} className="w-full bg-surface-2 p-4 rounded-xl outline-none focus:ring-2 ring-accent transition-all text-sm resize-none" placeholder="Décrivez vos actions ici..."></textarea>
                    </div>
    ...
    <div className="pt-32 pb-20 bg-bg min-h-screen">
      <div className="container-custom">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white p-6 md:p-12 rounded-2xl md:rounded-3xl shadow-xl border border-border mb-16">
            <h3 className="text-xl md:text-2xl font-display font-bold text-primary mb-6">S'abonner à la liste</h3>
            <div className="flex flex-col sm:flex-row gap-4">
              <input className="flex-1 bg-surface-2 p-4 md:p-5 rounded-xl border border-border outline-none focus:ring-2 ring-accent transition-all text-sm" placeholder="Votre adresse email professionnelle ou personnelle" />
              <button className="btn-primary py-4 md:py-5 px-10">Rejoindre <Send size={18} /></button>
            </div>
...
export default function App() {
  ...
  const renderContent = () => {
    switch (currentPage) {
      ...
      case 'newsletter':
        return <NewsletterView onBack={() => navigateTo('home')} />;
      case 'join':
              ...
              <div className="container-custom grid lg:grid-cols-2 gap-24 items-center">
                ...
                <div className="relative reveal mt-12 lg:mt-0">
                  <div className="aspect-[4/5] rounded-3xl overflow-hidden shadow-2xl relative z-10 border-4 md:border-8 border-white">
                    <img src="https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?auto=format&fit=crop&q=80&w=1200" alt="Action Solidaire" className="w-full h-full object-cover" />
                  </div>
            ...
            <section className="py-16 md:py-20 bg-accent overflow-hidden relative">
               ...
               <div className="container-custom relative z-10 flex flex-col lg:flex-row items-center justify-between gap-10 md:gap-12 text-center lg:text-left">
                 ...
                 <div className="flex flex-col sm:flex-row w-full lg:w-auto gap-3">
                    <input type="email" placeholder="votre@email.com" className="px-6 py-4 rounded-xl bg-white/80 border-none outline-none focus:bg-white transition-all w-full lg:w-72 text-sm" />
                    <button className="bg-primary-dark text-white p-4 rounded-xl hover:bg-primary transition-all flex items-center justify-center shrink-0">
      ...
      <header className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${isScrolled ? 'header-scroll' : 'bg-transparent py-6'}`}>
        <nav className="container-custom flex items-center justify-between">
          <div className="flex items-center gap-4 cursor-pointer" onClick={() => navigateTo('home')}>
            <img src="https://cdn.shopify.com/s/files/1/0079/5557/8943/files/Logo_pafha_transparent_1.png?v=1776177602" alt="Logo PAFHA" className="h-12 md:h-16" />
          </div>
               ...
               <form className="space-y-6">
                 <div className="grid sm:grid-cols-2 gap-6">
                   ...
                   <div className="space-y-2">
                     ...
                     <input className="w-full bg-surface-2 p-4 rounded-xl outline-none focus:ring-2 ring-accent transition-all text-sm" placeholder="jean@email.com" />
                   </div>
                 </div>
                 <div className="space-y-2">
                   <label className="text-[10px] font-bold uppercase tracking-widest text-text-light ml-2">Sujet</label>
                   <input className="w-full bg-surface-2 p-4 rounded-xl outline-none focus:ring-2 ring-accent transition-all text-sm" placeholder="Comment pouvons-nous vous aider ?" />
                 </div>
                 <div className="space-y-2">
                   <label className="text-[10px] font-bold uppercase tracking-widest text-text-light ml-2">Message</label>
                   <textarea rows={4} className="w-full bg-surface-2 p-4 rounded-xl outline-none focus:ring-2 ring-accent transition-all text-sm resize-none" placeholder="Votre message ici..."></textarea>
                 </div>
      ...
      <footer className="bg-primary-dark text-white pt-24 pb-12 overflow-hidden relative">
        ...
        <div className="container-custom relative z-10">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-16 mb-24">
            <div className="reveal">
              <img src="https://cdn.shopify.com/s/files/1/0079/5557/8943/files/Logo_pafha_transparent_1.png?v=1776177602" alt="Logo PAFHA" className="h-16 mb-8 grayscale invert opacity-80" />
            ...
            <div className="reveal">
              ...
              <div className="flex gap-2 mb-4">
                <input className="bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-xs w-full focus:ring-1 ring-accent outline-none" placeholder="votre@email.com" />
                <button className="p-3 bg-secondary rounded-lg hover:brightness-110 transition-all"><Send size={16}/></button>
              </div>
              <button 
